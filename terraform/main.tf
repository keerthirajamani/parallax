...
# ==============================================================================
# AWS LAMBDA (ZIP-BASED WEBHOOK)
# ==============================================================================

# 1. Zip the lambda_handlers folder
...
resource "aws_lambda_function" "webhook_lambda" {
  ...
  handler       = "webhook_trigger.lambda_handler" # File webhook_trigger.py -> function lambda_handler
  runtime       = "python3.10"
...
# ==============================================================================
# AMAZON EC2 (DOCKER-BASED SIGNAL ENGINE)
# ==============================================================================
